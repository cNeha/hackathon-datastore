...
# Set Location and template
log(:info, "BHP: About to set the Location")
mylocation = prov.get_option(:dialog_param_location_dc)
mytemplate = prov.get_option(:dialog_param_os)
log(:info, "BHP: Location is #{mylocation}")
if mylocation == "houston_dc1"
  $evm.log(:info, "BHP: Houston DC1 is detected")
  my_ext_management_system = "Test_Dev_HDC_1"
  if mytemplate == "Linux RHEL"
    log(:info, "BHP: template is #{mytemplate}")
	myvm_template = "Template-vRA-RHEL_76"
  elsif mytemplate == "Windows"
    log(:info, "BHP: template is #{mytemplate}")
	myvm_template = "Template-vRA-WS2016-STD"
  end
  prov.set_option(:vm_template, myvm_template)
  prov.set_option(:ext_management_system, my_ext_management_system)
  prov.set_option(:placement_dc_name, "HOU1-ES")
  prov.set_option(:placement_cluster_name, "HOU1-ES-NONPROD")
  prov.set_option(:placement_host_name, "hou1pesx161.ent.bhpbilliton.net")
  prov.set_option(:placement_ds_name, "ESX_HOU1_ES_NONPROD_PERF_08")
  prov.set_option(:prod_net, "HOU1-ENT-VM1-DEV_3755")
  
elsif mylocation == "houston_dc2"
  $evm.log(:info, "BHP: Houston DC2 is detected")
  my_ext_management_system = "Test_Dev_Vcenter_HDC_2"
  if mytemplate == "Linux RHEL"
    log(:info, "BHP: template is #{mytemplate}")
	myvm_template = "Template-vRA-RHEL_76"
  elsif mytemplate == "Windows"
  ...
  prov.set_option(:vm_template, myvm_template)
  prov.set_option(:ext_management_system, my_ext_management_system)
  prov.set_option(:placement_dc_name, "HOU2-ES")
  prov.set_option(:placement_cluster_name, "HOU2-ES-NONPROD")
  prov.set_option(:placement_host_name, "hou2pesx161.ent.bhpbilliton.net")
  prov.set_option(:placement_host_name, "ESX_HOU2_ES_NONPROD_PERF_08")
  prov.set_option(:placement_host_name, "HOU2-ENT-VM1-DEV_3755")
end
