...
uri                     = "#{server_url}/api/now/table/sys_user?sysparm_limit=5"
...
$evm.log(:info, "===ServiceNow API payload: #{hash}")
data= hash["result"][0]["name"]
#$evm.log(:info, "===ServiceNow API payload: #{hash["result"][0]}")
#$evm.log(:info, "===ServiceNow API User: #{data}")
